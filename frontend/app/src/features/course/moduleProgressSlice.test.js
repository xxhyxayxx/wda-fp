...
import moduleProgressReducer, {
  completeProgress,
  fetchCourseProgress,
} from './moduleProgressSlice';
...
describe('moduleProgressSlice', () => {
  ...
  it('completeProgress - fulfilled', async () => {
    const moduleId = 1;
  ...
  it('completeProgress - rejected', async () => {
    const moduleId = 1;
  ...
  it('fetchCourseProgress - fulfilled', async () => {
    const courseId = 1;
  ...
  it('fetchCourseProgress - rejected', async () => {
    const courseId = 1;
