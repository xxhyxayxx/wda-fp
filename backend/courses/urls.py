...
from .views import (
    ...
    FileCreateAPIView, FileUpdateAPIView, FileDeleteAPIView, FileListAPIView, ModuleOrderUpdateAPIView
)
...
urlpatterns = [
    ...
    path('modules/order/update/', ModuleOrderUpdateAPIView.as_view(), name='module-order-update'),  # 新しい順序更新のエンドポイント
